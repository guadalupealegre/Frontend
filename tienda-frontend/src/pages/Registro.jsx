...
export default function Registro() {
  ...
  // Estado del formulario: el checkbox arranca desmarcado (false) por requerimiento legal
  ...
  // Función única de cambio controlando checkboxes y campos de texto
  const cambiar = (e) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validación previa de consentimiento (Ley 25.326)
    ...
    <div className="max-w-xl mx-auto py-8 px-4 animate-fade-in">
      <div className="bg-white rounded-3xl border border-amber-100/90 shadow-warm p-6 sm:p-10 space-y-6">
        ...
        <div className="text-center space-y-2">
          <div className="w-12 h-12 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-orange-600 flex items-center justify-center mx-auto">
        ...
        {/* Mensaje de Éxito */}
        {exito && (
          <div className="bg-emerald-50 border border-emerald-200 text-emerald-800 p-4 rounded-2xl flex items-center space-x-3 text-sm animate-fade-in">
            ...
            <div className="p-4 rounded-2xl bg-amber-50/70 border border-amber-200/80 space-y-3">
              <div className="flex items-start space-x-3">
                <input
                  ...
                  onChange={cambiar}
                  className="mt-1 w-4 h-4 text-orange-600 rounded border-stone-300 focus:ring-orange-500 cursor-pointer"
                />
                <label
              ...
              <div className="flex items-center space-x-1.5 text-[11px] text-amber-800/80 pl-7">
