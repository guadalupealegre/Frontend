...
export default function MisDatos() {
  ...
  if (error) {
    return (
      <div className="max-w-2xl mx-auto my-8 p-8 bg-rose-50 border border-rose-200 rounded-3xl text-center space-y-4">
        ...
        <button
          onClick={cargarDatos}
          className="px-6 py-3 bg-[#3B111E] text-white rounded-xl text-xs font-bold hover:bg-[#E85D88] transition-colors shadow-sm"
        >
          Reintentar
        </button>
      </div>
  ...
  return (
    ...
    >
      {/* Cabecera Principal */}
      <div className="bg-[#3B111E] text-[#FAF8F5] p-8 rounded-3xl shadow-xl border border-rose-900/40 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <button
          ...
          disabled={exportando}
          className="px-6 py-4 rounded-2xl bg-[#E85D88] hover:bg-[#D81B60] text-white font-extrabold text-xs uppercase tracking-wider shadow-lg shadow-[#E85D88]/30 flex items-center justify-center space-x-2 transition-all active:scale-95 shrink-0 self-stretch md:self-auto disabled:opacity-60"
        >
          {exportando ? (
            <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-3xl border border-rose-200/80 shadow-sm p-6 space-y-4">
          <div className="flex items-center space-x-3 pb-3 border-b border-rose-100">
            ...
            <div>
              <h2 className="font-serif font-bold text-lg text-[#3B111E]">
          ...
          <div className="space-y-3 text-xs">
            <div className="flex justify-between py-1.5 border-b border-stone-100">
              ...
              <span className="font-bold text-[#3B111E]">{perfil.nombre}</span>
            </div>
            <div className="flex justify-between py-1.5 border-b border-stone-100">
            ...
            <div className="flex justify-between py-1.5 border-b border-stone-100">
              ...
              <span className="font-semibold uppercase tracking-wider text-[#E85D88] bg-[#FFF1F5] px-2.5 py-0.5 rounded-full border border-rose-200">
                {perfil.rol}
              </span>
            </div>
              ...
              >
                <div className="space-y-1">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="font-mono font-extrabold text-sm text-[#E85D88] tracking-wider">
                      {rev.codigo}
                    </span>
                  </div>
      ...
      <div className="bg-rose-50 border-2 border-rose-300 rounded-3xl p-6 sm:p-8 space-y-6 shadow-sm">
        ...
        {/* Explicación legal de baja */}
        <div className="bg-white rounded-2xl p-5 border border-rose-200 space-y-3 text-xs text-stone-700 leading-relaxed">
        ...
        <div className="pt-2 flex justify-end">
          <button
            ...
            className="px-6 py-3.5 rounded-2xl bg-rose-700 hover:bg-rose-800 text-white text-xs sm:text-sm font-bold shadow-md flex items-center space-x-2 transition-all"
          >
            ...
            >
              ...
              <div className="p-4 rounded-2xl bg-rose-50 border border-rose-200 space-y-2 text-xs">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white border border-rose-300 rounded-xl font-mono text-sm uppercase text-stone-900 focus:outline-none focus:ring-2 focus:ring-rose-500"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                ...
                <button
                  ...
                  className="py-3 px-4 rounded-xl bg-rose-600 hover:bg-rose-700 text-white text-xs font-bold shadow-md flex items-center justify-center space-x-1.5 transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                >
                  {procesandoBaja ? (
                    <>
                      <Loader2 className="w-4 h-4 animate-spin" />
